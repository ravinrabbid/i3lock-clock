...
#define curs_lock_width 28
#define curs_lock_height 40
static unsigned char curs_lock_bits[] = {
...
#define mask_lock_width 28
#define mask_lock_height 40
static unsigned char mask_lock_bits[] = {
...
xcb_window_t open_fullscreen_window(xcb_connection_t *conn, xcb_screen_t *scr, char *color, xcb_pixmap_t pixmap, bool hide) {
    uint32_t mask = 0;
    uint32_t values[3];
...
xcb_cursor_t create_cursor(xcb_connection_t *conn, xcb_screen_t *screen, xcb_window_t win, int choice) {
    ...
    switch (choice) {
        ...
        case CURS_WIN:
            ...
            break;
        case CURS_LOCK:
            curs_bits = curs_lock_bits;
            mask_bits = mask_lock_bits;
            curs_w = curs_lock_width;
            curs_h = curs_lock_height; 
            break;
        case CURS_DEFAULT:
        default:
